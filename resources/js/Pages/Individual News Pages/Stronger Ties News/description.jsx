    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
                ...
                {/* Article Body */}
                <div className="text-sm sm:text-base md:text-lg text-gray-200 leading-relaxed space-y-4">
                    <p>
                        Renewed and empowered – linkage has been created as University of Makati (UMaK) and Moonton Philippines
                        Technologies, Inc. ties close connection, pursuant to knowledge acquisition and innovation of industry-university
                        endeavors.
                    </p>
