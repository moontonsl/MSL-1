...
export default function GM26Network() {
    ...
    const [form, setForm] = useState({
        ...
        facebookLink: "",
        email: "",
        community: "Network - MSL Network/Campuses",
        school: "",
        mlbbId: "",
        mlbbServer: "",
        postLink: "",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append("event_name", "GM26Network");
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Golden Month Network Registration" />
            <Helmet>
                <title>GM26 Network Registration</title>
            </Helmet>
            ...
            >
                ...
                <div
                    className="p-6 w-full max-w-3xl shadow-lg border-2 backdrop-blur-md bg-black/75"
