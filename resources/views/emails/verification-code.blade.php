                                ...
                                <tr>
                                    <td class="card-body" style="padding: 40px 35px;">
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 30px; border-bottom: 1px solid #f1f5f9; padding-bottom: 30px; text-align: center;">
                                            <tr>
                                                <td>
                                                    ...
                                                    <h2 style="font-size: 15px; color: #333333; margin: 0; font-weight: normal; font-family: Arial, sans-serif;">Account Verification</h2>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <div style="font-size: 14px; color: #333333; text-align: left; font-family: Arial, sans-serif;">
                                            ...
                                            <p style="margin: 0 0 20px 0;">We received a request to verify your email address associated with your MSL Account.</p>
                                            ...
                                            <!-- How to verify -->
                                            <div style="font-size: 14px; font-weight: bold; color: #000000; margin: 30px 0 12px 0;">How to verify your email:</div>
                                            <ol style="margin: 0 0 25px 0; padding-left: 20px;">
                                                <li style="margin-bottom: 8px;">Navigate to the MSL account verification screen.</li>
                                                <li style="margin-bottom: 8px;">Enter the verification code provided above.</li>
                                                <li style="margin-bottom: 8px;">Click "Verify Code" or complete your registration.</li>
                                                <li style="margin-bottom: 8px;">Your account verification will be completed immediately.</li>
                                            </ol>
                                            
                                            <!-- Important Notice -->
                                            <p style="margin: 20px 0;">
                                                <strong>Important Notice:</strong> This verification code will expire in 10 minutes. If you do not verify your email address within this timeframe, you will need to initiate a new request to generate a new code.
                                            </p>
                                            
                                            <!-- Didn't request this change? -->
                                            <p style="margin: 20px 0;">
                                                <strong>Didn't request this code?</strong> If you did not request to verify your email address, please ignore this message. Your email address will remain unverified, and your account is secure.
                                            </p>
